...
import { B as theme, R as colorize, S as shortenHomePath, z as isRich$1 } from "./utils-BKDT474X.js";
import "./thinking-BB3zi8pq.js";
import { Bt as maskApiKey, a as DEFAULT_OAUTH_WARN_MS, d as runEmbeddedPiAgent, gt as resolveUsageProviderId, ht as formatUsageWindowSummary, o as buildAuthHealthSummary, pt as loadProviderUsageSummary, s as formatRemainingShort, zt as describeFailoverError } from "./reply-BbSLW0A9.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-DCKfYrWF.js";
import { f as defaultRuntime } from "./subsystem-DypCPrmP.js";
import "./openclaw-root-CFLIucxC.js";
import "./exec-DNET3cHX.js";
import { $ as resolveApiKeyForProvider, Ci as DEFAULT_PROVIDER, Jr as setAuthProfileOrder, Kr as listProfilesForProvider, Qr as ensureAuthProfileStore, Rr as getShellEnvAppliedKeys, Si as DEFAULT_MODEL, Vr as shouldEnableShellEnvFallback, Vt as loadConfig, Yr as upsertAuthProfile, Z as getCustomProviderApiKey, _t as resolveProfileUnusableUntilForDisplay, ai as resolveOpenClawAgentDir, c as modelKey, d as normalizeProviderId, et as resolveAwsSdkEnvVarName, f as parseModelRef, ft as resolveAuthProfileOrder, g as resolveDefaultModelForAgent, h as resolveConfiguredModelRef, i as findNormalizedProviderValue, ii as resolveAuthStorePathForDisplay, mn as parseDurationMs, r as buildModelAliasIndex, tt as resolveEnvApiKey, ui as resolveAuthProfileDisplayLabel, v as resolveModelRefFromString } from "./model-selection-CY9xYYOZ.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-BFdii3Yb.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-CI4yKRoY.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-BGNs16eo.js";
...
import { a as COPILOT_FAST_FORWARD_COMPAT_CANDIDATES, i as COPILOT_1M_FORWARD_COMPAT_CANDIDATES, o as resolveForwardCompatModel, r as ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES } from "./model-PT4_COZt.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-aSBNHQae.js";
import "./help-format-BbI3Tgeg.js";
import { r as withProgressTotals } from "./progress-DZWqZ1es.js";
...
import { f as openUrl } from "./onboard-helpers-B0LiyFGq.js";
...
import { t as createClackPrompter } from "./clack-prompter-DTI-QJ5t.js";
import { t as renderTable } from "./table-D2IFT86t.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-BiJ7ZhU_.js";
import { n as redactSecrets } from "./format-C45cCSv0.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-DfGMyJfB.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-CTGem6qH.js";
import { n as logConfigUpdated } from "./logging-BPYlagf2.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-CmL-5Ss-.js";
...
async function loadModelRegistry(cfg) {
	...
	try {
		...
		for (const candidate of ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES) {
			...
			if (hasAvailableTemplate(availableKeys, candidate.templatePrefixes)) availableKeys.add(key);
		}
		for (const candidate of COPILOT_1M_FORWARD_COMPAT_CANDIDATES) if (hasAvailableTemplate(availableKeys, candidate.templatePrefixes)) availableKeys.add(candidate.key);
		for (const candidate of COPILOT_FAST_FORWARD_COMPAT_CANDIDATES) if (hasAvailableTemplate(availableKeys, candidate.templatePrefixes)) availableKeys.add(candidate.key);
	} catch (err) {
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./model-selection-CY9xYYOZ.js").then((n) => n.Lt);
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-PT4_COZt.js").then((n) => n.t);
