...
import { f as defaultRuntime, p as restoreTerminalState } from "./subsystem-DypCPrmP.js";
import { Ut as readConfigFileSnapshot, qt as writeConfigFile } from "./model-selection-CY9xYYOZ.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-B0LiyFGq.js";
import { t as assertSupportedRuntime } from "./runtime-guard-DHGnrIqj.js";
import { t as WizardCancelledError } from "./prompts-DSAwtDAg.js";
import { t as createClackPrompter } from "./clack-prompter-DTI-QJ5t.js";
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DG_wSD1u.js";
import { t as runOnboardingWizard } from "./onboarding-B8RpvlNM.js";
import { n as logConfigUpdated } from "./logging-BPYlagf2.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-8-LOzBb5.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-C4mXhqj0.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-CaP6WScd.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-BaWjTcWy.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-BZBx8TMB.js").then((n) => n.i);
