import { $t as resolveStateDir, Ut as resolveConfigPath, Zt as resolveOAuthDir } from "./entry.js";
import { A as createConfigIO, C as inspectPathPermissions, Cn as MAX_INCLUDE_DEPTH, Ht as normalizeTrustedSafeBinDirs, S as formatPermissionRemediation, Sn as INCLUDE_KEY, nt as isDangerousNetworkMode, rt as normalizeNetworkMode, w as safeStat, x as formatPermissionDetail } from "./auth-profiles-Dcaw_pRh.js";
import { t as formatCliCommand } from "./command-format-BYm_a0tW.js";
import { M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, d as resolveDefaultAgentId } from "./agent-scope-wyaXMjZL.js";
...
import { u as normalizePluginsConfig } from "./manifest-registry-CgvV3cyf.js";
import { l as normalizeStringEntries } from "./dock-0IVUql9P.js";
import { i as loadWorkspaceSkillEntries } from "./skills-BzU66Osv.js";
...
import { Rt as normalizeDeviceMetadataForPolicy, t as GatewayClient } from "./client-e1hu3brc.js";
import { c as READ_SCOPE, t as buildGatewayConnectionDetails } from "./call-BnTnEvsX.js";
import { t as resolveGatewayCredentialsFromConfig } from "./credentials-DQGpxZLN.js";
import { C as resolveToolProfilePolicy, f as resolveSandboxConfigForAgent, k as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, l as execDockerRaw, m as resolveSandboxToolPolicyForAgent, u as getBlockedBindReason } from "./sandbox-D2iibWvS.js";
import { a as resolveGatewayAuth } from "./auth-BKjNhyMQ.js";
import { a as resolveProfile, c as resolveBrowserControlAuth, i as resolveBrowserConfig } from "./server-context-BTjcJGC5.js";
import { n as formatErrorMessage } from "./errors-Cu3BYw29.js";
import { r as resolveMergedSafeBinProfileFixtures, t as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-pPXLAbSq.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled } from "./commands-CmSWGWiQ.js";
...
import { l as resolveDmAllowState, n as isToolAllowedByPolicies, o as pickSandboxToolPolicy } from "./pi-tools.policy-snzCSkSF.js";
...
import { i as NODE_SYSTEM_RUN_COMMANDS, r as NODE_SYSTEM_NOTIFY_COMMAND, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-CTMfX7Ne.js";
import { c as normalizeTelegramAllowFromEntry, s as isNumericTelegramUserId, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-DV7U9yby.js";
