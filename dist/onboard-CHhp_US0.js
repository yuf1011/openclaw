import { qt as resolveGatewayPort, st as resolveUserPath, v as defaultRuntime, y as restoreTerminalState } from "./entry.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-BDYpA07u.js";
import { t as WizardCancelledError } from "./prompts-NOUgk6FH.js";
import { t as createClackPrompter } from "./clack-prompter-BHH70N-4.js";
import { t as assertSupportedRuntime } from "./runtime-guard-Bxkrgx8-.js";
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-C9W4Cc6I.js";
import { t as runOnboardingWizard } from "./onboarding-DXISQYsP.js";
import { n as logConfigUpdated } from "./logging-Bi2fXy2a.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-BaEzXNGQ.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-BFyV_anJ.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-Cqny5FTx.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-CzWYIwz7.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-IEWlQTak.js").then((n) => n.i);
