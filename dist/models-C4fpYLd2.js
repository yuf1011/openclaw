...
import { Dt as isRich$1, Et as colorize, Ot as theme, Rt as CONFIG_PATH, ut as shortenHomePath } from "./entry.js";
import { $n as findNormalizedProviderValue, Fn as upsertAuthProfile, Gn as resolveOpenClawAgentDir, Jr as resolveApiKeyForProvider, Kr as getCustomProviderApiKey, Mn as listProfilesForProvider, Pn as setAuthProfileOrder, Qn as buildModelAliasIndex, Qr as getShellEnvAppliedKeys, Rn as ensureAuthProfileStore, Wn as resolveAuthStorePathForDisplay, Xr as resolveEnvApiKey, Yr as resolveAwsSdkEnvVarName, bi as DEFAULT_PROVIDER, dr as resolveDefaultModelForAgent, it as parseDurationMs, j as loadConfig, n as resolveAuthProfileOrder, or as normalizeProviderId, pr as resolveModelRefFromString, rr as modelKey, s as resolveProfileUnusableUntilForDisplay, sr as parseModelRef, ti as shouldEnableShellEnvFallback, ur as resolveConfiguredModelRef, xi as resolveAuthProfileDisplayLabel, yi as DEFAULT_MODEL } from "./auth-profiles-Dcaw_pRh.js";
import { t as formatCliCommand } from "./command-format-BYm_a0tW.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-wyaXMjZL.js";
import { a as COPILOT_FAST_FORWARD_COMPAT_CANDIDATES, i as COPILOT_1M_FORWARD_COMPAT_CANDIDATES, o as resolveForwardCompatModel, r as ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES } from "./model-vydB19V0.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-D02SmS2n.js";
import { Cn as resolveUsageProviderId, Sn as formatUsageWindowSummary, Tt as describeFailoverError, bn as loadProviderUsageSummary, nn as buildAuthHealthSummary, rn as formatRemainingShort, s as runEmbeddedPiAgent, tn as DEFAULT_OAUTH_WARN_MS, wn as maskApiKey } from "./subagent-registry-BXwMeJTd.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-4nKmwJd-.js";
import { t as ensureOpenClawModelsJson } from "./models-config-Cgq90zgz.js";
import { n as loadModelCatalog } from "./model-catalog-YGBrWSuE.js";
import { r as withProgressTotals } from "./progress-CbbocNs7.js";
import { f as openUrl } from "./onboard-helpers-BDYpA07u.js";
...
import { t as inferParamBFromIdOrName } from "./model-param-b-CqnGs_t4.js";
import { n as redactSecrets } from "./format-CAxLZtkK.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-HL_Ns84E.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-BLPMn46U.js";
import { n as logConfigUpdated } from "./logging-Bi2fXy2a.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-Dd_LgA6c.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./auth-profiles-Dcaw_pRh.js").then((n) => n.D);
	const { ensureAuthProfileStore } = await import("./auth-profiles-Dcaw_pRh.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-vydB19V0.js").then((n) => n.t);
