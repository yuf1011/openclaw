import { o as parseBooleanValue, qt as resolveGatewayPort } from "./entry.js";
import { A as createConfigIO, L as writeConfigFile, j as loadConfig } from "./auth-profiles-Dcaw_pRh.js";
import { r as isLoopbackHost } from "./net-DxQ7jfWx.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-BQUn6wym.js";
import { A as DEFAULT_OPENCLAW_BROWSER_ENABLED, C as stopChromeExtensionRelayServer, D as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, E as DEFAULT_AI_SNAPSHOT_MAX_CHARS, O as DEFAULT_BROWSER_EVALUATE_ENABLED, S as ensureChromeExtensionRelayServer, T as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, _ as appendCdpPath, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as withBrowserNavigationPolicy, h as assertBrowserNavigationResultAllowed, i as launchOpenClawChrome, j as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, k as DEFAULT_OPENCLAW_BROWSER_COLOR, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenClawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchJson, w as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, y as fetchOk } from "./chrome-C0o6OwfT.js";
import { a as resolveGatewayAuth } from "./auth-BKjNhyMQ.js";
import { c as normalizeBrowserFormField, i as resolveExistingPathsWithinRoot, n as DEFAULT_TRACE_DIR, o as resolveWritablePathWithinRoot, r as DEFAULT_UPLOAD_DIR, t as DEFAULT_DOWNLOAD_DIR } from "./paths-DmaSOFYG.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-Cu3BYw29.js";
import { t as SsrFBlockedError } from "./ssrf-CUvqCfry.js";
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-CcPn9dc7.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-KiHr3NOJ.js");
	} catch (err) {
