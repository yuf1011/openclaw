...
import { $t as resolveStateDir, Dt as isRich, Et as colorize, Ot as theme, St as setVerbose, lt as shortenHomeInString, s as createSubsystemLogger, st as resolveUserPath, ut as shortenHomePath, v as defaultRuntime } from "./entry.js";
import { it as parseDurationMs, j as loadConfig, ln as splitShellArgs } from "./auth-profiles-Dcaw_pRh.js";
...
import { f as listMemoryFiles, p as normalizeExtraMemoryPaths } from "./query-expansion-B3FVYwN6.js";
import { t as formatDocsLink } from "./links-C8KzbyCM.js";
import { r as withManager } from "./cli-utils-lehxsosf.js";
import { t as formatHelpExamples } from "./help-format-CQtXw6X8.js";
import { n as withProgress, r as withProgressTotals } from "./progress-CbbocNs7.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-CypH_KOo.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-wiZK_UV8.js").then((n) => n.t);
