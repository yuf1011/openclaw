...
import { Dt as isRich, Ot as theme, _t as info, qt as resolveGatewayPort } from "./entry.js";
import { N as readConfigFileSnapshot, bi as DEFAULT_PROVIDER, j as loadConfig, ur as resolveConfiguredModelRef, vi as DEFAULT_CONTEXT_TOKENS, yi as DEFAULT_MODEL } from "./auth-profiles-Dcaw_pRh.js";
import { t as formatCliCommand } from "./command-format-BYm_a0tW.js";
import { u as resolveAgentWorkspaceDir } from "./agent-scope-wyaXMjZL.js";
...
import { Z as resolveFreshSessionTotalTokens, c as loadSessionStore, nt as resolveMainSessionKey } from "./sessions-CaYHTPpt.js";
import { n as listChannelPlugins } from "./plugins-CQDL2vOs.js";
import { At as summarizeRestartSentinel, Dn as buildChannelAccountSnapshot, En as buildChannelSummary, Nn as peekSystemEvents, On as formatChannelAllowFrom, bn as loadProviderUsageSummary, kt as readRestartSentinel, xn as formatUsageReportLines } from "./subagent-registry-BXwMeJTd.js";
import { l as resolveStorePath } from "./paths-4nKmwJd-.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-BnTnEvsX.js";
import { o as getTailnetHostname, s as readTailscaleStatusJson } from "./tailscale-R5nsrkpg.js";
import { n as inspectPortUsage, o as formatPortDiagnostics } from "./ports-BSBaTdIY.js";
import { r as getMemorySearchManager } from "./memory-cli-DUZJ2TmR.js";
import { n as formatTimeAgo } from "./format-relative-CLDwoKCS.js";
import { r as formatDurationPrecise } from "./format-duration-pIcWg99c.js";
import { d as resolveContextTokensForModel, l as resolveSessionModelRef, n as classifySessionKey, r as listAgentsForGateway } from "./session-utils-BcVoGDzb.js";
import { o as getRemoteSkillEligibility } from "./skill-commands-CeEd_Cn1.js";
import { a as sha256HexPrefix } from "./active-listener-CqTrxxIg.js";
import { n as withProgress } from "./progress-CbbocNs7.js";
import { C as normalizeControlUiBasePath, g as resolveControlUiLinks } from "./onboard-helpers-BDYpA07u.js";
...
import { s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-B11aFvIY.js";
import { t as formatRuntimeStatusWithDetails } from "./runtime-status-Ct-XO6zk.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-DN2n86RE.js";
import { t as renderTable } from "./table-CiZxPm0N.js";
import { i as resolveGatewayProbeAuth$1, s as probeGateway, t as runSecurityAudit } from "./audit-D0DaTThb.js";
import { o as resolveHeartbeatSummaryForAgent, t as formatHealthChannelLines } from "./health-IEWlQTak.js";
import { _ as resolveUpdateChannelDisplay, a as formatGitInstallLabel, h as normalizeUpdateChannel, n as checkUpdateStatus, t as resolveDefaultChannelAccountContext } from "./channel-account-context-DQeNiCoD.js";
import { t as resolveNodeService } from "./node-service-CZm0VTZM.js";
import { n as redactSecrets, t as formatGatewayAuthUsed } from "./format-CAxLZtkK.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, r as getUpdateCheckResult, t as formatUpdateAvailableHint } from "./status.update-CXCXo5iu.js";
import { t as shortenText } from "./text-format-DtcxeAjY.js";
...
async function scanStatusJsonFast(opts) {
	...
	const gatewayMode = isRemoteMode ? "remote" : "local";
	const gatewayProbePromise = remoteUrlMissing ? Promise.resolve(null) : probeGateway({
	...
	const channelsStatusPromise = gatewayReachable ? callGateway({
		method: "channels.status",
		params: {
			probe: false,
			timeoutMs: Math.min(8e3, opts.timeoutMs ?? 1e4)
