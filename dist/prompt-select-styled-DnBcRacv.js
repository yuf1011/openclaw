import { $t as resolveStateDir, Jt as resolveIsNixMode, Rt as CONFIG_PATH, Zt as resolveOAuthDir, dt as sleep, jt as getResolvedLoggerSettings, qt as resolveGatewayPort, r as isTruthyEnvValue$1, sn as resolveRequiredHomeDir, st as resolveUserPath, ut as shortenHomePath, v as defaultRuntime } from "./entry.js";
...
import { a as resolveAgentDir, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, u as resolveAgentWorkspaceDir } from "./agent-scope-wyaXMjZL.js";
import { w as parseAgentSessionKey } from "./session-key-qmb11-mH.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-BlnoStgN.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-DtAnKlnZ.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-B14641Rh.js";
import { V as cleanStaleLockFiles, c as loadSessionStore, nt as resolveMainSessionKey, ot as formatSessionArchiveTimestamp, st as isPrimarySessionTranscriptFileName } from "./sessions-CaYHTPpt.js";
import { n as listChannelPlugins } from "./plugins-CQDL2vOs.js";
import { _ as loadOpenClawPlugins, ir as resolveAgentSessionDirs, nn as buildAuthHealthSummary, rn as formatRemainingShort, tn as DEFAULT_OAUTH_WARN_MS } from "./subagent-registry-BXwMeJTd.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-4nKmwJd-.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-BnTnEvsX.js";
import { r as isLoopbackHost, u as resolveGatewayBindHost } from "./net-DxQ7jfWx.js";
import { D as DEFAULT_SANDBOX_COMMON_IMAGE, E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-D2iibWvS.js";
import { a as resolveGatewayAuth } from "./auth-BKjNhyMQ.js";
import { n as inspectPortUsage, o as formatPortDiagnostics } from "./ports-BSBaTdIY.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-DUZJ2TmR.js";
...
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-Bhzol8KH.js";
import { l as resolveDmAllowState } from "./pi-tools.policy-snzCSkSF.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-BN4v0ir0.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-BDYpA07u.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-BZr96Wob.js";
import { t as note$1 } from "./note-DVRsi_b1.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-vxNL6Tmx.js";
import { d as resolveSystemNodeInfo, l as renderSystemNodeWarning, n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-CbdxeoLg.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-C9W4Cc6I.js";
import { l as uninstallLegacySystemdUnits, r as isSystemdUserServiceAvailable } from "./systemd-BnVNVk7J.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-B11aFvIY.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-BdjFLV0B.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-DN2n86RE.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-zngwH6Ej.js";
import { r as healthCommand } from "./health-IEWlQTak.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-Bd0CbG0U.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-DQeNiCoD.js";
import { t as runGatewayUpdate } from "./update-runner-b3Vpwp6s.js";
import { n as logConfigUpdated } from "./logging-Bi2fXy2a.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-DdoR9C8x.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-D0b0fbno.js";
import { t as formatHealthCheckFailure } from "./health-format-D9a_VD-0.js";
import { n as doctorShellCompletion } from "./doctor-completion-D9cW0LZB.js";
