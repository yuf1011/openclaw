...
import { Ct as isAvatarHttpUrl, Dt as isWorkspaceRelativeAvatarPath, Gn as resolveOpenClawAgentDir, St as isAvatarDataUrl, Tt as isPathWithinRoot, bi as DEFAULT_PROVIDER, dr as resolveDefaultModelForAgent, j as loadConfig, kt as resolveAvatarMime, sr as parseModelRef, tr as inferUniqueProviderFromConfiguredModels, ur as resolveConfiguredModelRef, vi as DEFAULT_CONTEXT_TOKENS, xt as AVATAR_MAX_BYTES, yi as DEFAULT_MODEL } from "./auth-profiles-Dcaw_pRh.js";
import { d as resolveDefaultAgentId, u as resolveAgentWorkspaceDir } from "./agent-scope-wyaXMjZL.js";
import { c as normalizeMainKey, s as normalizeAgentId, w as parseAgentSessionKey, x as isCronRunSessionKey } from "./session-key-qmb11-mH.js";
import { a as openBoundaryFileSync } from "./openclaw-root-BlnoStgN.js";
import { $ as canonicalizeMainSessionAlias, M as readSessionTitleFieldsFromTranscript, Z as resolveFreshSessionTotalTokens, c as loadSessionStore, ct as buildGroupDisplayName, et as resolveAgentMainSessionKey, nt as resolveMainSessionKey, w as normalizeSessionDeliveryFields } from "./sessions-CaYHTPpt.js";
...
(async () => {
	...
	try {
		const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-D02SmS2n.js").then((n) => n.r);
